    ...
    <React.Fragment>
      ...
      <form onSubmit={submitHandler}>
        <fieldset>
          ...
          <select value={childsNum} id="childsNum" onChange={(e) => setChildsNum(e.target.value)}>
          ...
          {childrenAgesRender(childsNum).map((el, i) => (
            <React.Fragment>
              <label htmlFor={'child'[i]}>age</label>
              <input type="text" id={'child'[i]} key={i} value={details.children[i]} size="2" />
            </React.Fragment>
          ))}
        </fieldset>
        <fieldset>
      ...
      <button onClick={() => console.log(childsNum)}>view childs</button>
